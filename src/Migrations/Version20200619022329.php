 ...
 */
final class Version20200619022329 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE property CHANGE owner_id owner_id INT NOT NULL, CHANGE category_id category_id INT NOT NULL, CHANGE updated_at updated_at DATETIME NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE property CHANGE owner_id owner_id INT DEFAULT NULL, CHANGE category_id category_id INT DEFAULT NULL, CHANGE updated_at updated_at DATETIME DEFAULT NULL');
    }
}
